            ...
            <div id="content-left">
                ...
                <div id="top">
                    <el-breadcrumb separator-class="el-icon-arrow-right" id="breadcrumb">
                        ...
                        <el-breadcrumb-item>学习手册</el-breadcrumb-item>
                    </el-breadcrumb>
                </div>
                <div id="eather">
...
import { getquestionlist, getarticletotal } from '../api/index'
export default {
    ...
    methods: {
        async getdata() {
            ...
            await getquestionlist(params).then((res) => {
                if(res.code == 200){
                    this.datalist = res.message;
                }
            })
            await getarticletotal({ type: 1 }).then((res) => {
                if(res.code == 200){
